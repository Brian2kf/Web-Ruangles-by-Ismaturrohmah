...
if (!$data) {
    echo "<script>alert('Data tidak ditemukan'); window.location='feedback_pengajar.php';</script>";
    exit;
}
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href="feedback_pengajar.php">Feedback</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="proses_feedback_pengajar.php" method="POST">
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="feedback_pengajar.php" class="btn btn-secondary">Kembali</a>
                                </div>
                            </form>
                        </div>
