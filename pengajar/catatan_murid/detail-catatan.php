                    ...
                    <table class="table table-hover" id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-catatan.php?id_progres=<?= $data['id_progres'] ?>&id_kelas=<?= $id_kelas ?>" class="btn btn-sm btn-warning text-white" title="Edit Catatan"><i class="fa-solid fa-pen text-white"></i> Edit Catatan</a>
                                </td>
                            </tr>
                            <?php 
                                } 
