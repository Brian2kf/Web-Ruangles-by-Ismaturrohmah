        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= $main_url ?>admin/kelas/add-kelas.php" class="btn btn-primary float-end" title="Tambah Kelas"><i class="fa-solid fa-plus"></i> Tambah Kelas</a>
                </div>
                <div class="card-body">
                    <table class="table table-hover" id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-kelas.php?id_kelas_bimbel=<?= $data['id_kelas_bimbel'] ?>" class="btn btn-sm btn-warning" title="Update Data Kelas"><i class="fa-solid fa-pen text-white"></i></a>
                                    
                                    <a href="ubah-jadwal.php?id_kelas_bimbel=<?= $data['id_kelas_bimbel'] ?>" class="btn btn-sm btn-success" title="Kelola Jadwal"><i class="fa-solid fa-clock text-white"></i></a>

                                    <a href="hapus-kelas.php?id_kelas_bimbel=<?= $data['id_kelas_bimbel'] ?>" class="btn btn-sm btn-danger" title="Hapus Kelas" onclick="return confirm('Anda yakin akan menghapus data kelas ini ? Menghapus kelas akan menghapus SEMUA jadwal terkait.')"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
