...
if (isset($_POST['simpan'])) {
    ...
    if ($username !== $data['username']) {
        ...
        if (mysqli_num_rows($checkUser) > 0) {
            ...
            header("location:profile_admin.php?msg=username_exists");
            exit;
        }
    }
    ...
    if (!empty($newPass)) {
        ...
        if (empty($oldPass)) {
            ...
            header("location:profile_admin.php?msg=oldpass_empty");
            exit;
        }
        ...
        if (password_verify($oldPass, $currentDbHash)) {
            ...
            header("location:profile_admin.php?msg=oldpass_wrong");
            exit;
        }
    }
    ...
    header("location:profile_admin.php?msg=updated");
    return;
}
?>